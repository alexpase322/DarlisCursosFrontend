  ...
  return (
    ...
    <div className="max-w-7xl mx-auto p-4 md:p-6 relative min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-8">
        ...
        <Link to="/admin/pagos" className="bg-white border border-gray-100 rounded-2xl p-5 hover:shadow-md transition flex items-center gap-3">
          <div className="p-3 rounded-xl bg-rose-100 text-rose-600"><DollarSign size={22} /></div>
          <div>
